...
btnEncriptar.addEventListener("click", e=>{
    ...
    if(texto == ""){
        ...
        atencion.style.background = "red";        
        atencion.style.fontWeight = "800";
        atencion.textContent = "No debe tener acentos ni caracteres especiales";
        ...
        atencion.style.background = "red";        
        atencion.style.fontWeight = "800";
        atencion.textContent = "El texto deb estar escrito en minúscula";
